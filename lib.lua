...
function Featherfall:init()
    local aliases = {
        ...
        platform_torii_gate = "platform/torii_gate",
        platform_speed_gate = "platform/torii_gate",
        platform_dash_gate = "platform/torii_gate",
        ...
        platform_bullet = "platform/bullet",
        platform_bullet_emitter = "platform/bullet_emitter",
        platform_bullet_blue = "platform/bullet",
